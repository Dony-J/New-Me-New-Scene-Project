...
![alt text](<Screenshot 2026-01-28 124428.png>) 

## Description of 2025 recap

In my 2025 Recape I put images of how my year went, and things I did throughout the year.

## Description of 2026 goals

IN my 2025 Recape So Far I put images of things that I have done this year so far and places I have went to. 
## Scene API Usage

I was able to use various methods from teh Scene API to create my animation by putt the drawScene method and creating text to provide what I did throught my years. I made another class that held all of my images and I called them from that class into my year class using a for(method).
